...
export const AlbumFormModal = ({ initial, year, onSave, onClose, isLoading }) => {
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <FLabel label="Accent Color">
                        <div className="flex gap-2.5 items-center">
                            ...
                            <span className="text-[13px] text-gray-400 font-['Outfit',_sans-serif]">Album theme color</span>
                            <div className="w-6 h-6 rounded-full border border-black/10 shadow-sm" style={{ background: form.accent }} />
                        </div>
                    </FLabel>
                </div>
