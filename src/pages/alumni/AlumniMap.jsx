  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/40 pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <StatPill icon={Users} value={mapData.stats?.totalAlumni || 0} label="Alumni Located" color="bg-blue-500" />
          <StatPill icon={Globe} value={mapData.stats?.countriesRepresented || 0} label="Countries" color="bg-emerald-500" />
          <StatPill icon={MapPin} value={mapData.stats?.citiesRepresented || 0} label="Cities" color="bg-amber-500" />
        </motion.div>
            ...
            {selectedAlumni ? (
              ...
              >
                ...
                <div className="flex-1 px-5 py-2 overflow-y-auto">
                  ...
                  <ModalRow icon={Mail} label="Email" iconColor="text-blue-500" bgColor="bg-blue-50">
                  ...
                  {selectedAlumni.jobTitle && (
                    <ModalRow icon={Briefcase} label="Position" iconColor="text-blue-600" bgColor="bg-blue-50">
                  ...
                  {selectedAlumni.linkedin && (
                    <ModalRow icon={Linkedin} label="LinkedIn" iconColor="text-blue-600" bgColor="bg-blue-50">
                ...
                <div className="px-5 py-4 border-t border-slate-100 flex gap-2.5">
                  ...
                  <a href={`mailto:${selectedAlumni.email}`}
                    className={`flex items-center justify-center gap-2 py-2.5 rounded-xl border text-xs font-bold active:scale-95 transition-all ${selectedAlumni.linkedin
