    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-start gap-3">
          <div
            className={`relative shrink-0 w-14 h-14 rounded-xl bg-linear-to-br ${gradient} flex items-center justify-center text-white text-lg font-black shadow-md overflow-hidden`}
          >
            {photoUrl ? (
              <img
                src={photoUrl}
...
const AlumniCardLimited = ({ alumni, index }) => {
  ...
  return (
    ...
    >
      <div className={`h-1 w-full bg-linear-to-r ${gradient} opacity-40`} />
      <div className="p-4 flex items-center gap-3">
        {/* Blurred avatar placeholder */}
        <div
          className={`shrink-0 w-11 h-11 rounded-xl bg-linear-to-br ${gradient} opacity-30 flex items-center justify-center`}
        >
        ...
        <div
          className="shrink-0 w-7 h-7 rounded-lg bg-slate-50 flex items-center justify-center"
          title="Limited view"
        >
